...
print(colored("- 1) Moyen : Votre nombre est compris entre 0 et 100 (15 essais MAX)","blue"))
print(colored("- 1) Difficile : Votre nombre est compris entre 0 et 100 (5 essais MAX)","blue"))
