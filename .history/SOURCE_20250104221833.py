...
print(colored("- 1) Moyen : Votre nombre est compris entre 0 et 100 (10 essai MAX)","blue"))
print(colored("- 1) Difficile : Votre nombre est compris entre 0 et 100 (30 essai MAX)","blue"))
print("")
